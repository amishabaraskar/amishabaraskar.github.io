...
export default function Portfolio() {
  return (
    <div className="font-sans tracking-wide flex h-screen bg-indigo-950 overflow-x-hidden hide-scrollbar">
      {/* Header */}
            <header className="  h-screen  ml-10 flex items-center   gap-10  text-white py-12    shadow-lg">
<div >
        <h1 className="text-6xl font-extrabold  my-7">Amisha B.</h1>
        <p className="text-lg opacity-90 mb-5">Web Developer</p>
        <nav>
...
<li><a href="https://www.linkedin.com/in/amisha-baraskar-82938b180/" target="_blank"><svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="hover:stroke-white lucide lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg></a></li>
      ...
      <div className="flex-1  overflow-y-auto">
              <section id="About" className="text-slate-500 font-medium max-w-3xl mx-auto mt-8  rounded-2xl shadow-2xl py-8 px-4 md:px-10 ">
<p >
...
<div className="flex-grow"><span className="text-white font-semibold text-lg">Frontend Developer . TCS</span>
          ...
          {projects.map(proj => (
            ...
            >
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-slate-600 font-medium mb-4 flex-1">{proj.description}</p>
                <a
                  href={proj.repo}
                  target="_blank"
